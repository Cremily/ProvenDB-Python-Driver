...
class PrepareForgetResponse(ProvenResponse):
    def __init__(self, document: Dict[str, Any]):
        ...
        self.forgetSummary: PrepareForgetSummary = PrepareForgetSummary(self['forgetSummary'])
class ExecuteForgetResponse(ProvenResponse):
    def __init__(self, document: Dict[str, Any]):
        super().__init__(document)  
        self.status: str = document['status']
        self.forgetSummary: ExecuteForgetSummary = ExecuteForgetSummary(document['forgetSummary'])